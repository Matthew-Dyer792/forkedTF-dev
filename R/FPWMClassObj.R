...
setGeneric(name = "updateFPWMClassObj",
           def = function(theObject,xid, id, nSites, nPeaks, matrix, betalevel,score, forkPosition,  forked, parentbeta,parentmatrix) {
...
setMethod(f = "updateFPWMClassObj",
          ...
          definition = function(theObject,xid, id, nSites, nPeaks, matrix, betalevel,score, forkPosition, forked, parentbeta,parentmatrix) {
